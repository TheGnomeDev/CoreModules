...
namespace CollectionTests
{
    public class ListDragAndDropTestWindow : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            // Import UXML
            var visualTreeAsset = EditorGUIUtility.Load("Assets/ToolkitSample/ListDragAndDropTestWindow.uxml") as VisualTreeAsset;
            visualTreeAsset.CloneTree(root);

            // Load the PlayerItemView.uxml file
            var playerItemAsset = EditorGUIUtility.Load("Assets/ToolkitSample/PlayerItemView.uxml") as VisualTreeAsset;
